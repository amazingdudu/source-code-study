			...
			/***/ function (module, exports, __webpack_require__) {
				...
				function createHistory() {
					...
					function getTransitionConfirmationMessage() {
						...
						for (
							var i = 0, len = transitionHooks.length;
							i < len && typeof message !== 'string';
							++i
						)
					...
					function pushState(state, path) {
						transitionTo(
							_createLocation2['default'](path, state, _Actions.PUSH, createKey())
						);
					}

					function replaceState(state, path) {
						transitionTo(
							_createLocation2['default'](path, state, _Actions.REPLACE, createKey())
						);
					}
